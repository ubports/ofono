...
#define PREF_NET_TYPE_TD_SCDMA_GSM_WCDMA_CDMA_EVDO_AUTO 21
#define PREF_NET_TYPE_TD_SCDMA_LTE_CDMA_EVDO_GSM_WCDMA 22
...
#define RIL_RAF_GPRS (1 << RADIO_TECH_GPRS)
#define RIL_RAF_EDGE (1 << RADIO_TECH_EDGE)
#define RIL_RAF_UMTS (1 << RADIO_TECH_UMTS)
#define RIL_RAF_IS95A (1 << RADIO_TECH_IS95A)
#define RIL_RAF_IS95B (1 << RADIO_TECH_IS95B)
#define RIL_RAF_1xRTT (1 << RADIO_TECH_1xRTT)
#define RIL_RAF_EVDO_0 (1 << RADIO_TECH_EVDO_0)
#define RIL_RAF_EVDO_A (1 << RADIO_TECH_EVDO_A)
#define RIL_RAF_HSDPA (1 << RADIO_TECH_HSDPA)
#define RIL_RAF_HSUPA (1 << RADIO_TECH_HSUPA)
#define RIL_RAF_HSPA (1 << RADIO_TECH_HSPA)
#define RIL_RAF_EVDO_B (1 << RADIO_TECH_EVDO_B)
#define RIL_RAF_EHRPD (1 << RADIO_TECH_EHRPD)
#define RIL_RAF_LTE (1 << RADIO_TECH_LTE)
...
#define RIL_RC_STATUS_SUCCESS 1
#define RIL_RC_STATUS_FAIL 2
